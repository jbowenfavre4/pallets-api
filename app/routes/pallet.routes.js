module.exports = app => {
    ...
    router.get('/miscExpenses/:palletId', pallets.getMiscExpenses)
    router.get('/revenue/:palletId', pallets.getRevenue)
    router.get('/numbers/:palletId', pallets.getPalletNumbers)
